...
{ constructor()                              // containing two values: a 3D position and a color.
    { super( "positions", "colors" );                       // Name the values we'll define per each vertex.
      this.positions = [ Vec.of(0,0,0), Vec.of(1,0,0), Vec.of(0,1,0)];   // Describe the where the points of a triangle are in space.
      this.colors    = [ Color.of(1,0,0,1), Color.of(0,1,0,1), Color.of(0,0,1,1)];   // Besides a position, vertices also have a color.
